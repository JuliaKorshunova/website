...
export default function SecondImgButtonPink( {onClick, children, pressed, hover, className, typeofbuttton,disabled, onMouseDown1, isActive, onMouseEnter,onMouseOver,  onMouseOut , onMouseLeave, isImg, ...props }) { //оставшиеся входящие параметры
