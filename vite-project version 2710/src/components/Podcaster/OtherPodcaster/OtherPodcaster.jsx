...
export default function OtherPodcaster() {
  ...
  function ispressed1(){
    ...
    return(
        ...
        <div className='personforOP'>
          <img className='imgforOP' src={person} />
        </div>

        <div className='obedinenieforOP'>
          ...
          <section  key={index} className='sforOP'>
            ...
            <div className="pinkblock">
              <div className="whiteblock">
                ...
                <h6 className='thesecforOP'>{pod.descriptionn
                  }</h6>

                <div className='seroeforOP'>
