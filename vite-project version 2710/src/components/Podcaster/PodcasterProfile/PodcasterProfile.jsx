...
export default function Podcaster() {
  ...
  const handleMouseLeave5= () => {
    ...
    return(
        ...
        <div className='personforpod'>
          <img  className='imgforpod' src={person} />
        </div>

        <div className='obedinenieforpod'>
          ...
          <section  key={index} className='sforpod'>
            ...
            <div className="pinkblock">
              <div className="whiteblock">
                ...
                <h6 className='thesecforpod'>{pod.descriptionn
                  }</h6>

                <div className='seroeforpod'>
                  <div className='a'><img className='im1' src={link} /> </div>
                  <a className='ssylka'>{pod.link}</a> </div>
                <div className='groupofbtnforpod'>
