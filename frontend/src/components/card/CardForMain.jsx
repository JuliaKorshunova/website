import './CardForMain.css'; 
import React, { useState } from "react";   
import star from './../../img/звездочка.svg';   
import MainButton2 from '../Button/MainButton2';
 
export default function CardForMain({ mainPage }) {  
  ...
  return (     
    <div className="_card">     
        <div className="_blackblock" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>    
