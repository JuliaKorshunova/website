          ...
          <div className="whiteblocksub">
            ...
            <div className="frame_91"  ref={hashtagsRef}>     
                            ...
                            <div
                                key={hIndex}
                                data-text={h} 
                                className={`hastags1 ${overlappingHashtags.includes(hIndex) ? 'gradient' : 'orange'}`} 
                            >
                            {h}
                        </div> ))}
                              </div>
            ...
            <img src={image3} alt='logo' className='picturesub'  ref={imageRef} />    
            <img src={image2} alt='logo' className='picturesub1' />    
