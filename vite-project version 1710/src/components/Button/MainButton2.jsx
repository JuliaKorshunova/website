...
export default function Button2( {onClick, children, pressed, hover, className, typeofbuttton,disabled, onMouseDown1, onMouseEnter, onMouseLeave, ...props }) { //оставшиеся входящие параметры
