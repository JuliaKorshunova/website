...
export default function Podcaster() {
    ...
    useEffect(() => {
        fetch('/datarelrecommend.json')
            ...
            .then((data) => {
                ...
                setRecommendData(data); // Устанавливаем отсортированные данные
            })
    ...
    useEffect(() => {
        ...
        fetch('/datarelgroup.json')
            ...
            .then((data) => setDataRelGroup(data))
            .catch((error) => console.error('Ошибка при загрузке данных:', error));
    }, []);
    ...
    useEffect(() => {
        ...
        fetch('/datarelabout.json')
            ...
            .then((data) => setDataRelAbout(data))
            .catch((error) => console.error('Ошибка при загрузке данных:', error));
    }, []);
            ...
            .then((data) => {
                ...
                sortedData.forEach(comment => {
                    comment.subComments.sort((a, b) => {
                        if (!a.data || !b.data) {
                            console.error('Недоступная дата подкомментария', a, b);
                            return 0;
                        }
                        ...
                        if (isNaN(dateA) || isNaN(dateB)) {
                            console.error('Неверная дата подкомментария', a.data, b.data);
                            return 0;
                        }
