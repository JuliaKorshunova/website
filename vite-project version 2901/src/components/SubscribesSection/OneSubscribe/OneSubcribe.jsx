...
export default function OneSubcribe({ name, descriptionn, time, author, sub,  image1, image2, image3, hashtags, className }) {   
      ...
      <div  className="cardsub">    
        <div className="blackblocksub">    
          <div className="whiteblocksubribes">
            ...
            <img src={image2} alt='logo' className='picturesub1ForSub' ref={imageRef}  />    
            <div className="containersubForSubscribes">    
              ...
              <div className='smesh_button'>
                   { isHovered === true ? (
                       ...
                       onMouseLeave={handleMouseLeave}
                   >
                    <img className="image-class" src={playlist_add_Img} alt={ 'Изображение кнопки'} />
                   </SecondImgButton>) : 
                   (
