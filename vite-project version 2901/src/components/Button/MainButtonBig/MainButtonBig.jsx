...
export default function MainButtonBig( {onClick, children, pressed, hover, className, typeofbuttton,disabled, onMouseDown1, onMouseEnter, onMouseLeave, ...props }) { //оставшиеся входящие параметры
